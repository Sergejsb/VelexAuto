                        ...
                        <Grid.Row>
                            <Grid.Column width={12}>
                                    <p className='us'>
                                        ...
                                        обслуживания. За время существования мы зарекомендавали себя себя как
                                        надежного партнера,готового оперативно решать непредвиденные проблемы.
                                        Учитывая конъюнктуру рынка Беларуси(температурный режим, распутица и т.д.),
                                        наши сотрудники выработали план действий,который позволяет доставлять
                                        грузы в срок.
                                    </p>
                            </Grid.Column>
                        </Grid.Row>
